...
import { blogDetail, blogs, pageHero } from '../data/content';
...
export const BlogSinglePage = () => {
  const { id } = useParams();
  const post: BlogPost | undefined = id ? blogs.find((item) => item.id === id) : undefined;
          ...
          <div className="row">
            <div className="col-lg-8 ftco-animate">
              ...
              <p className="text-muted">
                {(post && post.date) || 'June 27, 2019'} &bull; {(post && post.author) || 'Admin'}
              </p>
              <p>{detail.body[0]}</p>
              <p>
